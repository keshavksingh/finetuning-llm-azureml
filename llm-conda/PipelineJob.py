...
myenv = Environment(name="llmenv")
run_config = RunConfiguration(conda_dependencies=conda)
run_config.environment.docker.enabled = True

exp = Experiment(workspace=ws, name="AML-FINETUNE-LLM-V1")
step_1 = PythonScriptStep(source_directory='C:pythonprojects/aml/llm-conda',
...
pipeline_run = pipeline.submit("AML-FINETUNE-LLM-V1", regenerate_outputs=True)