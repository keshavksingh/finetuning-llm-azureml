...
conda.add_pip_package('trl')
conda.add_pip_package('einops')

myenv = Environment(name="llmfalconenv")
run_config = RunConfiguration(conda_dependencies=conda)
run_config.environment.docker.enabled = True

exp = Experiment(workspace=ws, name="AML-FINETUNE-FALCON-LLM-V1")
step_1 = PythonScriptStep(source_directory='C:pythonprojects/aml/llm-falcon',
...
pipeline_run = pipeline.submit("AML-FINETUNE-FALCON-LLM-V1", regenerate_outputs=True)